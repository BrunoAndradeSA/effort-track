...
export function initSettingsUi() {
  ...
  const emailsTextarea = document.getElementById("settings-stakeholder-emails");
  ...
  function openModal() {
    ...
    emailsTextarea.value = (settings.stakeholderEmails || []).join("\n");
  ...
  form.addEventListener("submit", (e) => {
    ...
    const emails = parseEmails(emailsTextarea.value);
