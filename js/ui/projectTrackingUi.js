...
export function initProjectTrackingUi() {
  ...
  function renderProjects() {
    ...
    filteredProjects.forEach(({ project, metrics }) => {
        ...
        <div class="project-card-header">
          ...
          <div style="display: flex; flex-direction: column; align-items: flex-end; gap: 0.5rem;">
            ...
            <div class="project-card-actions">
              ...
              <button class="project-card-btn btn-pdf-proj" title="Baixar relatório em PDF" aria-label="Baixar PDF do projeto ${project.title}">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
      ...
      card.querySelector('.btn-pdf-proj').addEventListener('click', (e) => {
        downloadPdfReport(project, metrics);
      });
